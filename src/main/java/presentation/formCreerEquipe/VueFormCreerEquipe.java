...
public class VueFormCreerEquipe extends JDialog {
    ...
    public VueFormCreerEquipe(int idGerant) {
        this.idGerant = idGerant;
        ControleurFormCreerEquipe controleur = new ControleurFormCreerEquipe(this);
